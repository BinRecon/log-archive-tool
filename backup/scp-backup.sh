#!/usr/bin/env bash
# Example: SCP Backup Configuration
# This script demonstrates production-grade SCP backup setup
# Usage: ./examples/scp-backup.sh
...
REMOTE_USER="admin"
REMOTE_PATH="/home/admin/backups/logs"
SSH_PORT=22
...
echo "=========================================="
echo "Log Archive Tool - SCP Backup Example"
echo "=========================================="
echo ""
echo "Configuration:"
